...
public class GravestonesClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        EntityRendererRegistry.register(ModEntities.GRAVESTONE_SKELETON_ENTITY_TYPE, SkeletonEntityRenderer::new);
        BlockEntityRendererFactories.register(ModBlocks.GRAVESTONE, GravestoneBlockEntityRenderer::new);
    }
}